...
//   asyncHandler(async (req, res) => {
//     const result =
//       await CalculatorsServices.getCalculationMonthsLeftInTheYearCalculator(
//         req.body
//       );
...
//   asyncHandler(async (req, res) => {
//     const result =
//       await CalculatorsServices.getCalculationHowManyDaysUntilBirthdayCalculator(
//         req.body
//       );
...
//   asyncHandler(async (req, res) => {
//     const result =
//       await CalculatorsServices.getCalculationMonthsFromNowCalculator(req.body);
...
//   asyncHandler(async (req, res) => {
//     const result =
//       await CalculatorsServices.getCalculationWeekLeftInTheYearCalculator(
//         req.body
//       );
